...
mkCSOWithTransforms (g1, t1, it1) (g2, t2, it2) =
                    MinkowskiSum (TransformedShape g1 t1 it1) $ ShapeReflection $ TransformedShape g2 t2 it2
...
mkAnnotatedCSOWithTransforms (g1, t1, it1) (g2, t2, it2) =
                    AnnotatedMinkowskiSum (TransformedShape g1 t1 it1) $ ShapeReflection $ TransformedShape g2 t2 it2
